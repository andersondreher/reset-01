public class AppCombate {
    ...
    public static void main(String[] args) {
        ...
        Magia misselMagico = new Magia("Míssel Mágico", 50, 3);
        Magia raioCongelante = new Magia("Raio Congelante", 15, 4);
        Magia bolaFogo = new Magia("Bola de Fogo", 15, 3);

        PoderDivino armaEspiritual = new PoderDivino("Arma Espiritual", 5, 5);
        ...
        // heróis
        Guerreiro ramza = new Guerreiro("Ramza", 10, 1.5, 15);
        Clerigo ovelia = new Clerigo("Ovelia", 10, 4.5, 0, 10);
        Druida vandroy = new Druida("Vandroy", 75, 2.5, 5, 5);

        // vilões
        Feiticeiro dycedarg = new Feiticeiro("Dycedarg", 55, 7.0, 3, 10);
        Mago gaffgarion = new Mago("Gaffgarion", 50, 2.5, 2, 20);
